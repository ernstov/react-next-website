export const page = {
  ...
  faq: [
    ...
    { question: "How’s Gawq funded?", answer: "The company is founded by Joshua Dziabiak, a serial entrepreneur and investor from Austin, TX. Joshua has invested his own money to create the first version of Gawq. Given the size and scope of our mission, we may consider outside investment to help support our growth. If and when we engage investors, it will be important that their objectives and investment strategies align with our values and vision for the company." },
    { question: "Who’s behind Gawq?", answer: "The company is founded by Joshua Dziabiak, a serial entrepreneur and investor from Austin, TX. You can read more about Joshua's background on his <a href="https://www.linkedin.com/in/joshua-dziabiak/" target="_blank">LinkedIn profile</a>. There are currently no institutional investors or other shareholders in the company. Almost 100% of the product and brand design was completed by Joshua himself. The engineering has been supported by several (incredible) contract developers, a couple of which work full-time for Gawq. Community moderation is largely supported by volunteers. If you're passionate about improving the media landscape, we'd love to hear from you!" },
